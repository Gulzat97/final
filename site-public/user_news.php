...
<form method="post" action="../user_news.php"  enctype="multipart/form-data" ></br> Title of news </br>
...
if(isset($_POST['add']))
{
   ...
   $img = mysql_query("  SELECT  image_id FROM image WHERE img = '$namefile'    ");
   echo "image = $namefile"; 
   echo "img = $img";
  /*mysql_query(" INSERT INTO news (title,text,date,time, users_id, image_id)
            VALUES('$title','$text1','$date','$time','$user_id', $img)  
  "); */
   //  include ("send.php");
    mysql_close();
